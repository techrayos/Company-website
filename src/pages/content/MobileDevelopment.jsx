          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-400 bg-clip-text text-transparent dark:from-white dark:via-neutral-200 dark:to-neutral-400">
                Empowering Brands Through Seamless Mobile Experiences
              </span>
            </motion.h1>
            ...
            >
              Build fast, secure, and user-friendly mobile apps that create real
              impact. High-performance apps built for both iOS and Android with
