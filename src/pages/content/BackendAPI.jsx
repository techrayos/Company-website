          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-400 bg-clip-text text-transparent dark:from-white dark:via-neutral-200 dark:to-neutral-400">
                Powering Experiences with Reliable Backend & API Solutions
              </span>
            </motion.h1>
            ...
            >
              Build strong, scalable, and secure systems that make your product
              perform effortlessly. Backend systems designed to handle growth,
              heavy traffic, and future expansion smoothly. Flexible and modern
              API structures that ensure smooth communication between systems.
            </motion.p>
