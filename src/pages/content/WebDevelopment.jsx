          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-400 bg-clip-text text-transparent dark:from-white dark:via-neutral-200 dark:to-neutral-400">
                Crafting Powerful Web Experiences
              </span>
            </motion.h1>
            ...
            >
              Build fast, secure, and visually stunning websites designed to
              grow with your business. Optimized for speed, responsiveness, and
