...
export default function CloudCaseStudies() {
        ...
        >
          ...
          >
            ...
            >
              ...
              <br />
              Cloud environments built to grow with your business — from
              startups to enterprises. <br />
              <br />
              🔐 Advanced Security
              <br />
              End-to-end encryption, access control, and compliance to keep your
              data fully protected.
              <br />
              <br />
              🚀 High Availability
              <br />
              Reliable uptime and performance to ensure your business runs
              smoothly 24/7.
              <br />
              <br />
              🌍 Global Accessibility
              <br />
              Access your data and systems from anywhere in the world, with
              real-time synchronization.
              <br />
              <br />
              🧭 Seamless Integration
              <br />
              Easy connection with existing systems, tools, and platforms for
              better efficiency.
              <br />
              <br />
              🛠️ Smart Monitoring & Support
              <br />
              Continuous performance tracking, alerts, and support to keep your
              cloud running perfectly.
              <br />
              <br />
            </motion.p>
          </motion.div>
