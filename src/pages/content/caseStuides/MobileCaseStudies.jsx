      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 md:py-28 lg:px-8 lg:py-32">
        ...
        >
          ...
          >
            ...
            >
              ⚡ Native & Cross-Platform Apps <br />
              High-performance apps built for both iOS and Android with smooth
              user experiences.
              <br />
              <br />
              🧭 Intuitive UI/UX Design
              <br />
              Clean, responsive interfaces crafted to keep users engaged and
              connected.
              <br />
              <br />
              🚀 Performance Optimization
              <br />
              Lightweight, fast-loading apps built with scalability and
              reliability in mind.
              <br />
              <br />
              🔐 Security First
              <br />
              End-to-end encryption and strong security protocols to protect
              user data.
              <br />
              <br />
              🌍 API & Backend Integration
              <br />
              Seamless connectivity with powerful APIs and backend systems for
              real-time functionality.
              <br />
              <br />
              🛠️ Continuous Support & Updates
              <br />
              Regular improvements, bug fixes, and feature upgrades to keep your
              app future-ready.
            </motion.p>
          </motion.div>
        </motion.div>
