      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 md:py-28 lg:px-8 lg:py-32">
        ...
        >
          ...
          >
            ...
            >
              🛒 Custom Store Development <br />
              Tailored e-commerce platforms designed to match your brand and
              business goals.
              <br />
              <br />
              🚀 High-Performance Checkout
              <br />
              Lightning-fast, secure, and seamless checkout flows to boost
              conversions and sales.
              <br />
              <br />
              📊 Real-Time Analytics
              <br />
              Track customer behavior, sales performance, and insights to make
              smarter decisions.
              <br />
              <br />
              📦 Inventory & Order Management
              <br />
              Simplified product handling with automated systems to manage stock
              and fulfillment efficiently.
              <br />
              <br />
              💳 Secure Payment Integrations
              <br />
              Multiple payment gateways with advanced encryption to ensure a
              safe and smooth buying experience.
              <br />
              <br />
              📱 Mobile-First Experience
              <br />
              Fully responsive design to deliver a flawless shopping journey on
              any device.
            </motion.p>
          </motion.div>
        </motion.div>
