      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 md:py-28 lg:px-8 lg:py-32">
        ...
        >
          ...
          >
            ...
            >
              Scalable, secure, and future-ready cloud solutions designed to
              accelerate innovation. Cloud environments built to grow with your
              business — from startups to enterprises. End-to-end encryption,
              access control, and compliance to keep your data fully protected.
            </motion.p>
