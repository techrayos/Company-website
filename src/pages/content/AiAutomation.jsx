          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-400 bg-clip-text text-transparent dark:from-white dark:via-neutral-200 dark:to-neutral-400">
                Smart, automated systems designed
              </span>
            </motion.h1>
            ...
            >
              ...
              forecast outcomes, and help you stay ahead. Seamlessly connect AI
              tools with your existing platforms, ensuring smooth operations and
              better productivity.
            </motion.p>
